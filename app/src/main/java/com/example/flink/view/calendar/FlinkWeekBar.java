...
public class FlinkWeekBar extends WeekBar {

    private int mPreSelectedIndex;

    public FlinkWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.layout_flink_week_bar, this, true);
