...
public class MeizuWeekView extends WeekView {
    ...
    private void init(Context context){
        mTextPaint.setTextSize(CommonTools.dip2px(context, 8));
        ...
        mRadio = CommonTools.dip2px(getContext(), 7);
        mPadding = CommonTools.dip2px(getContext(), 4);
        Paint.FontMetrics metrics = mSchemeBasicPaint.getFontMetrics();
        mSchemeBaseLine = mRadio - metrics.descent + (metrics.bottom - metrics.top) / 2 + CommonTools.dip2px(getContext(), 1);
    }
